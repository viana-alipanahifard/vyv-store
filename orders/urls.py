...
urlpatterns = [
    ...
    path('payment/<int:order_id>/',views.OrderPayView.as_view(), name='order_pay'),
    ...
    path('cart/increase/<int:product_id>/',views.CartIncreaseView.as_view(),name='cart_increase'),
